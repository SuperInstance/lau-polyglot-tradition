...
Polyglot Tradition — 7 cultural mathematical traditions expressing the same conservation laws differently
...
```bash
git clone https://github.com/SuperInstance/lau-polyglot-tradition
cd lau-polyglot-tradition
```
